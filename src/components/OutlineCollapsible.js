...
const { selectedItem } = useContext(GlobalContext)
    ...
    return (
        <div className={`pl-2 cursor-move rounded hover:bg-gray-100 hover:bg-opacity-60 ${selectedItem && props.item.id === selectedItem.id ? 'bg-gray-100' : ''} bg-opacity-60`} {...props}>
