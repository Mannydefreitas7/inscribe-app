    ...
    return (
        <div className="flex px-4 border-b justify-between">
          ...
          <div className="flex flex-row">
              ...
              <NavLink to="/extensions" activeClassName="border-b-4 border-pink-700 text-pink-700" className="px-4 py-4"><Badge color="secondary" variant="dot"><Typography>Extensions</Typography></Badge></NavLink>
